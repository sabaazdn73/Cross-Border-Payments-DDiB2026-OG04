...
| Sandbox approval delays | On-ramp blocked | Used the stub fallback (a mock `/api/payments` endpoint) rather than a real Stripe sandbox integration, avoiding the approval step entirely for this demo's scope |
