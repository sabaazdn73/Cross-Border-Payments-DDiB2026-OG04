...
- **Team of one in practice.**

### 23.3 Ethics
The system **cannot make anyone compliant**. It records that a licensed party asserted a check was performed, and when. It does not verify that the check was *good* — only that it was *made*, at a time nobody can move, and has not been revised since.

That distinction is deliberate and must be stated. Presenting the anchor as proof of compliance rather than proof of *assertion* would be exactly the overclaim this document exists to avoid.
