...
**Where genuine network effects do appear:**
...
**Note:** we are not technically constrained. We are **commercially constrained**, and we say so. Scaling this business means signing partners, not adding servers. That is a slower curve than a pure software product, and it is the same curve every licensed competitor faces.
